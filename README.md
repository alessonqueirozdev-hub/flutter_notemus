...
- [Status no pub.dev e evolução para 2.0.1](#status-no-pubdev-e-evolução-para-201)
...
- [flutter_notemus 2.0.1](https://pub.dev/packages/flutter_notemus)
...
- Fallback robusto para `repeatBoth`: https://github.com/alessonqueirozdev-hub/flutter_notemus/issues/5
