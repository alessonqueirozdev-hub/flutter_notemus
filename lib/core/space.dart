...
/// align voices or criar pausas invisíveis in notação específica.
///
/// ```dart
...
///
/// used for indicate a measure de pausa in partes orquestrais where
/// o instrumento not toca, sem display a pausa de semibreve normal.
///
/// ```dart
...
class MeasureSpace extends MusicalElement {
  ...
  /// Default = 1. used for pausas multi-measures comprimidas.
